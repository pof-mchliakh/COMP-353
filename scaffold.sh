...
yes | rails g scaffold Driver license_type_id:int --skip-migration
...
yes | rails g scaffold Reservation client_id:int mission_id:int address_id:int appointment_date:datetime expected_end_time:datetime --skip-migration
